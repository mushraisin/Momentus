...
export const DEFAULT_TIERS = [
  ...
  },
  {
    ...
    priority: 2,
    color: '#3ba55d',
    // Вимоги знижено: попередні (560 рейтингу, 300 повідомлень, 30 днів,
    // 120 проаналізованих) відсікали навіть тих, хто спокійно спілкується
    // місяцями. Довірена має бути досяжною для звичайного активного
    // учасника, а не майже такою ж рідкісною, як модераторська.
    req: {
      minScore: 460,
      minTrust: 52,
      minCommunication: 52,
