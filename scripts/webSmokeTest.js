...
// 31. один вигляд на весь сайт: шапка сторінки, драбина розмірів, порожні стани
{
  ...
  // У шапці лише назва: пояснювальний рядок під нею відсував сторінку вниз,
  // нічого не додаючи до того, що й так видно з вмісту.
  assert.ok(!/<h1>[^<]*<\/h1>\s*<p>/.test(pages.top.body), 'під назвою немає опису');
